"""
Seed script — inserts / updates Alocasia species and cultivars.

Naming conventions
──────────────────
  name         Scientific epithet + cultivar, e.g. "amazonica 'Polly'"
               Never includes the genus "Alocasia" — that is implied.
  common_name  Popular nickname ONLY, with NO "Alocasia" prefix.
               e.g. "Polly", "African Mask Plant", "Giant Taro"
  display_name Trade / market name used when listing the plant, always
               starts with "Alocasia", e.g. "Alocasia Polly"

Safe to re-run:
  - New entries are inserted.
  - Existing rows are updated with display_name and corrected common_name.
...
# price_min ≈ small pup/corm asking price
# price_max ≈ large mature specimen asking price
# ─────────────────────────────────────────────────────────────────────────────
...
SPECIES = [
    ...
    (
        ...
        "vigorous grower, similar care to the base species. Corms: $8-16, Pups: $16-32, Plants: $28-55.",
    ),
    (
    ...
    # Legacy standalone name used in older seed — kept so the existing DB row is updated
    (
        "'Stingray'",
        "Stingray",
        "Alocasia Stingray",
        ...
        "A cultivar of macrorrhizos. Corms: $6-14, Pups: $14-32, Plants: $28-65.",
    ),
    (
    ...
    (
        ...
        "widely sold 'Frydek' cultivar; provides the characteristic velvety texture. "
    ...
    (
        ...
        "Same velvety texture and white veins, dramatically larger scale. "
    ...
    (
        ...
        "Also called 'Maharani' or 'Grey Dragon'. Corms: $12-28, Pups: $28-60, Plants: $52-110.",
    ),
    (
        "sanderiana",
        "Kris Plant",
    ...
    (
        ...
        "Alocasia Reversa",
        "Moderate", 10, 60,
        "Thick oval leaves; undersides are more silvery-green than the tops — hence "
        "'reversa'. Unusual and underrated. Corms: $6-14, Pups: $14-28, Plants: $24-60.",
    ),
    (
        "'Ninja'",
        "Ninja",
    ...
    (
        ...
        "The colour contrast is most vivid in bright indirect light. "
    ...
    (
        ...
        "on each leaf — no two leaves alike. Striking collector plant. "
        "Corms: $12-26, Pups: $26-55, Plants: $48-100.",
    ),
    (
        "epilithica",
    ...
    (
        ...
        "Alocasia Macan",
        "Moderate", 18, 100,
        "Macan means 'tiger' in Indonesian — this cultivar features bold striped "
        "or mottled patterning. Not yet fully described botanically. "
        "Corms: $12-26, Pups: $26-55, Plants: $48-100.",
    ),
    (
        "'Bogani'",
    ...
    (
        ...
        "Moderate", 20, 110,
        "Named after the Surigao del Norte province in the Philippines. Dark leaves "
        "with pronounced veining; not yet formally described. "
        "Corms: $14-28, Pups: $28-58, Plants: $52-110.",
    ),
    (
        "'Samar'",
    ...
    (
        ...
        "Eastern Kalimantan with thick coriaceous leaves. The name means 'King' "
        "or 'Majesty' in Bahasa Indonesian. Corms: $10-24, Pups: $24-52, Plants: $45-100.",
    ),
    (
    ...
    (
        ...
        "Difficult", 12, 100,
        "Deep green form of the baginda cultivar group with the characteristic "
    ...
    (
        ...
        "Alocasia Melo",
        "Difficult", 20, 200,
        "Extraordinarily textured cement-grey leaves with deep ridging — like a "
        "melon skin. Restricted to ultramafic substrates in Borneo. Extremely rare. "
    ...
    (
        ...
        "Alocasia Puber",
        "Difficult", 20, 130,
        "Naturally inhabits swampy, waterlogged sites in its native range. "
        "Requires consistently moist substrate; unusual growing requirements. "
...
def seed():
    ...
    with get_connection() as conn:
        ...
        for (name, common_name, display_name, care_level,
             price_min, price_max, notes) in SPECIES:
            ...
            if key in existing:
                ...
                needs_update = (
                    ...
                    or (row["common_name"] and "alocasia" in row["common_name"].lower())
                )
                if needs_update:
                    conn.execute(
                        "UPDATE species SET "
                    ...
                    # Still backfill display_name if missing
    ...
    print(
        ...
        f"{updated} row{'s' if updated != 1 else ''} updated, "
